...
namespace LinqUebung1.Application
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            int result1 = db.Exams
    .Where(e => e.Examinator == "FAV")
    ...
    .First();
            ...
            double result2 = db.Exams
                .Where(e => e.Subject == "POS")
                .Where(e => e.Student.Gender == Gender.Female)
                .Average(e => e.Grade);
            ...
            List<Student> result3 = db.Students
               .Where(s => s.Exams.Count() >= 6)
               .ToList();
            ...
            List<Student> result4 = db.Students
                .Where(s => s.Exams.Any(e => e.Subject == "DBI"))
                .ToList();
            ...
            List<Student> result5 = db.Students
                .Where(s => s.Exams.All(e => e.Subject == "POS"))
                .ToList();
            ...
            List<Student> result6 = db.Students
    .Where(s => !s.Exams.Any(e => e.Subject == "POS"))
    .ToList();
            ...
            List<Student> result7 = db.Students
                .Where(s => !s.Exams.Any())
                .ToList();
            ...
            List<Exam> result8 = db.Exams
                .Where(e => e.Date.Month == 6 && e.Subject == "AM")
                .ToList();
            ...
            List<Student> result9 = db.Students
        .Where(s => s.Exams
        .Where(e => e.Subject == "E")
        .All(e => e.Grade == 5))
        .ToList();
            ...
            List<Student> result10 = db.Students
    .Where(s => s.Exams.Any(e => e.Subject == "DBI") && s.Exams.Any(e => e.Subject == "D"))
    .ToList()
    .Where(s =>
    {
        double dbiAverage = s.Exams
            .Where(e => e.Subject == "DBI")
            .Average(e => e.Grade);

        double dAverage = s.Exams
            .Where(e => e.Subject == "D")
            .Average(e => e.Grade);

        return dbiAverage < dAverage;
    })
    .ToList();
